...
func home(w http.ResponseWriter, r *http.Request) {
	...
	// If there is an error, we log the detailed error message and use the http.Error() function
	...
	// We then use Execute() method on the template set to write the template content as the response
