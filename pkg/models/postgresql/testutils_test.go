...
func newTestDB(t *testing.T) (*sql.DB, func()) {
	// Establish an sql.DB connection pool for our test database. Because our setup and teardown
	...
	// Return the connection pool and an anonymous function which reads and executes the teardown script
	// and closes the connection pool. We can assign this anonymous function and call it later once
